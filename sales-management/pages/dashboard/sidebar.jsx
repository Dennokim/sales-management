    ...
    <div className="w-[15%] md:block hidden">
      <nav className="w-[15%] fixed flex flex-col left-0 h-[100vh] bg-[#160F3F] p-4 space-y-8">
        ...
        <div className="w-full flex items-center">
          ...
          <Link href="/dashboard" className="text-[#9AA8BD] hover:text-white">
            Dashboard
          </Link>
        </div>
        ...
        <div className="w-full flex items-center">
          ...
          <Link href="/sales" className="text-[#9AA8BD] hover:text-white">
            Sales
          </Link>
        </div>
        ...
        <div className="w-full flex items-center">
          ...
          <Link href="/products" className="text-[#9AA8BD] hover:text-white">
            Products
          </Link>
        </div>
        ...
        <div className="w-full flex items-center">
          ...
          <Link href="/categories" className="text-[#9AA8BD] hover:text-white">
            Categories
          </Link>
        </div>
